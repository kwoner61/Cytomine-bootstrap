...
addSoftwareComputeTermArea(cytomine)
println 'ComputeTermArea added'

addSoftwareTissueDetect(cytomine)
println 'TissueDetect added'

addSoftwareTissueSegmentBuilder(cytomine)
addSoftwareTissueSegmentPrediction(cytomine)
println 'TissueSegment added'

addSoftwareCellClassifierFinder(cytomine)
addSoftwareCellClassifierBuilder(cytomine)
addSoftwareCellClassifierPrediction(cytomine)
addSoftwareCellClassifierValidation(cytomine)
println 'CellClassifier added'

addSoftwareLandMarkBuilder(cytomine)
addSoftwareLandMarkPredict(cytomine)
println 'LandMark added'

addSoftwareExportLandmark(cytomine)
println 'Export LandMark added'

addSoftwareGlmBuilder(cytomine)
println 'GlmBuilder added'

addSoftwareDmblLandmarkModelBuilder(cytomine)
println 'DmblLandmarkModelBuilder added'

addSoftwareLcLandmarkModelBuilder(cytomine)
println 'LcLandmarkModelBuilder added'

addSoftwareLandmarkGenericPredictor(cytomine)
println 'LandmarkGenericPredictor added'

addSoftwareLandmarkDmblPredictor(cytomine)
println 'LandmarkDmblPredictor added'

addSoftwareLandmarkLcPredictor(cytomine)
...
void addSoftwareComputeTermArea(Cytomine cytomine) throws Exception {
    try {
        ...
        cytomine.addSoftwareParameter('terms', 'ListDomain', software.getId(), '', true, 400,
                '/api/project/$currentProject$/term.json', 'name', 'name')
        cytomine.addSoftwareParameter('images', 'ListDomain', software.getId(), '', true, 500,
                '/api/project/$currentProject$/imageinstance.json', 'instanceFilename', 'instanceFilename')
...
void addSoftwareTissueDetect(Cytomine cytomine) throws Exception {
    try {
        Software software = cytomine.addSoftware('TissueDetect', 'createRabbitJobWithArgsService', 'ValidateAnnotation',
                'python algo/detect_sample/detect_sample.py --cytomine_host $host --cytomine_public_key $publicKey ' +
...
void addSoftwareTissueSegmentBuilder(Cytomine cytomine) throws Exception {
    try {
        Software software = cytomine.addSoftware('TissueSegment_Model_Builder', 'createRabbitJobWithArgsService',
                'ValidateAnnotation',
        ...
        cytomine.addSoftwareParameter('cytomine_id_software', 'Number', software.getId(), '', true, 400, null, null, null, true)
        cytomine.addSoftwareParameter('cytomine_id_project', 'Number', software.getId(), '', true, 500, null, null, null, true)
        cytomine.addSoftwareParameter('pyxit_save_to', 'String', software.getId(),
                'algo/segmentation_model_builder/logs/segmentation_tumor_model.pkl', true, 1600, null, null, null, true)
        // set by user
        cytomine.addSoftwareParameter('cytomine_annotation_projects', 'ListDomain', software.getId(), '', true, 600,
                '/api/ontology/$currentOntology$/project.json', 'name', 'name')
        cytomine.addSoftwareParameter('cytomine_zoom_level', 'Number', software.getId(), '0', true, 700)
        cytomine.addSoftwareParameter('cytomine_predict_terms', 'ListDomain', software.getId(), '', true, 800,
                '/api/project/$currentProject$/term.json', 'name', 'name')
        cytomine.addSoftwareParameter('cytomine_excluded_terms', 'ListDomain', software.getId(), '', true, 900,
                '/api/project/$currentProject$/term.json', 'name', 'name')
...
void addSoftwareTissueSegmentPrediction(Cytomine cytomine) throws Exception {
    try {
        Software software = cytomine.addSoftware('TissueSegment_Model_Predict', 'createRabbitJobWithArgsService',
                'ValidateAnnotation',
        ...
        cytomine.addSoftwareParameter('pyxit_load_from', 'String', software.getId(),
                'algo/segmentation_prediction/logs/segmentation_tumor_model.pkl', true, 2500, null, null, null, true)
        // set by user
        cytomine.addSoftwareParameter('model_id_job', 'Domain', software.getId(), '', true, 750,
                '/api/job.json?project=$currentProject$', 'softwareName', 'softwareName')
        cytomine.addSoftwareParameter('cytomine_zoom_level', 'Number', software.getId(), '2', true, 900)
        cytomine.addSoftwareParameter('cytomine_predict_term', 'Domain', software.getId(), '', true, 925,
                '/api/project/$currentProject$/term.json', 'name', 'name')
        cytomine.addSoftwareParameter('cytomine_roi_term', 'Domain', software.getId(), '', true, 950,
                '/api/project/$currentProject$/term.json', 'name', 'name')
...
void addSoftwareCellClassifierFinder(Cytomine cytomine) throws Exception {
    try {
        ...
        cytomine.addSoftwareParameter('cytomine_id_project', 'Number', software.getId(), '', true, 700, null, null, null, true)
        // set by user
        cytomine.addSoftwareParameter('cytomine_id_image', 'Domain', software.getId(), '', true, 800, 
                '/api/project/$currentProject$/imageinstance.json', 'instanceFilename', 'instanceFilename')
        cytomine.addSoftwareParameter('cytomine_predict_term', 'Domain', software.getId(), '', true, 850, 
                '/api/project/$currentProject$/term.json', 'name', 'name')
        cytomine.addSoftwareParameter('cytomine_zoom_level', 'Number', software.getId(), '1', true, 875)
        cytomine.addSoftwareParameter('cytomine_filter', 'String', software.getId(), 'adaptive', true, 890)
        //adaptive,binary or otsu
...
void addSoftwareCellClassifierBuilder(Cytomine cytomine) throws Exception {
    try {

        Software software = cytomine.addSoftware('Cell_Classifier_Model_Builder', 'createRabbitJobWithArgsService', 
                'ValidateAnnotation',
        ...
        cytomine.addSoftwareParameter('cytomine_id_project', 'Number', software.getId(), '', true, 700, null, null, null, true)
        cytomine.addSoftwareParameter('pyxit_save_to', 'String', software.getId(), 
                'algo/classification_model_builder/logs/classification_tumor_model.pkl', true, 1600, null, null, null, true)
        // set by user
        cytomine.addSoftwareParameter('cytomine_annotation_projects', 'ListDomain', software.getId(), '', true, 800, 
                '/api/ontology/$currentOntology$/project.json', 'name', 'name')
        cytomine.addSoftwareParameter('cytomine_zoom_level', 'Number', software.getId(), '0', true, 900)
        cytomine.addSoftwareParameter('cytomine_excluded_terms', 'ListDomain', software.getId(), '', true, 1000, 
                '/api/project/$currentProject$/term.json', 'name', 'name')
        cytomine.addSoftwareParameter('cytomine_predict_terms', 'ListDomain', software.getId(), '', true, 1050, 
                '/api/project/$currentProject$/term.json', 'name', 'name')
...
void addSoftwareCellClassifierPrediction(Cytomine cytomine) throws Exception {
    try {
        Software software = cytomine.addSoftware('Cell_Classifier_Model_Predict', 'createRabbitJobWithArgsService', 
                'ValidateAnnotation',
        ...
        cytomine.addSoftwareParameter('cytomine_id_image', 'Domain', software.getId(), '', true, 800, 
                '/api/project/$currentProject$/imageinstance.json', 'instanceFilename', 'instanceFilename')
        cytomine.addSoftwareParameter('cytomine_zoom_level', 'Number', software.getId(), '0', true, 900)
        cytomine.addSoftwareParameter('cytomine_id_userjob', 'Domain', software.getId(), '', true, 1000, 
                '/api/project/$currentProject$/user.json?showJob=true', 'username', 'username')
...
void addSoftwareLandMarkBuilder(Cytomine cytomine) throws Exception {
    try {
        Software software = cytomine.addSoftware('Landmark_Model_Builder', 'createRabbitJobWithArgsService', 
                'ValidateAnnotation',
        ...
        // set by user
        cytomine.addSoftwareParameter('cytomine_id_term', 'Domain', software.getId(), '', true, 800, 
                '/api/project/$currentProject$/term.json', 'name', 'name')
...
void addSoftwareLandMarkPredict(Cytomine cytomine) throws Exception {
    try {
        Software software = cytomine.addSoftware('Landmark_Model_Predict', 'createRabbitJobWithArgsService', 
                'ValidateAnnotation',
        ...
        // set by user
        cytomine.addSoftwareParameter('models_id_job', 'ListDomain', software.getId(), '', true, 1100, 
                '/api/job.json?project=$currentProject$', 'softwareName', 'softwareName')
    } catch (CytomineException e) {
        log.error(e)
    }
...
void addSoftwareCellClassifierValidation(Cytomine cytomine) throws Exception {
    try {
        Software software = cytomine.addSoftware('Cell_Classifier_Validation', 'createRabbitJobWithArgsService', 
                'ValidateAnnotation',
        ...
        cytomine.addSoftwareParameter('cytomine_id_project', 'Number', software.getId(), '', true, 700, null, null, null, true)
        // set by user
        cytomine.addSoftwareParameter('cytomine_annotation_projects', 'ListDomain', software.getId(), '', true, 750, 
                '/api/ontology/$currentOntology$/project.json', 'name', 'name')
        cytomine.addSoftwareParameter('cytomine_excluded_terms', 'ListDomain', software.getId(), '', true, 760, 
                '/api/project/$currentProject$/term.json', 'name', 'name')
        ...
        cytomine.addSoftwareParameter('forest_min_samples_split', 'Number', software.getId(), '2', true, 2800)
...
void addSoftwareExportLandmark(Cytomine cytomine) throws Exception {
    try {
...
void addSoftwareGlmBuilder(Cytomine cytomine) throws Exception {
    try {
        ...
        cytomine.addSoftwareParameter('cytomine_id_terms', 'ListDomain', software.getId(), '', true, 800, 
                '/api/project/$currentProject$/term.json', 'name', 'name')
        cytomine.addSoftwareParameter('cytomine_training_images', 'ListDomain', software.getId(), '', true, 850, 
                '/api/project/$currentProject$/imageinstance.json', 'filename', 'filename')
        cytomine.addSoftwareParameter('model_njobs', 'Number', software.getId(), '10', true, 900)
        cytomine.addSoftwareParameter('model_R', 'Number', software.getId(), '20', true, 1000)
        cytomine.addSoftwareParameter('model_RMAX', 'Number', software.getId(), '200', true, 1100)
        cytomine.addSoftwareParameter('model_P', 'Number', software.getId(), '3', true, 1200)
...
void addSoftwareDmblLandmarkModelBuilder(Cytomine cytomine) throws Exception {
    try {
        Software software = cytomine.addSoftware('DMBL_Landmark_Model_Builder', 'createRabbitJobWithArgsService', 
                'ValidateAnnotation',
        ...
        cytomine.addSoftwareParameter('cytomine_id_terms', 'ListDomain', software.getId(), '', true, 800, 
                '/api/project/$currentProject$/term.json', 'name', 'name')
        cytomine.addSoftwareParameter('cytomine_training_images', 'ListDomain', software.getId(), '', true, 900,
                '/api/project/$currentProject$/imageinstance.json', 'filename', 'filename')
...
void addSoftwareLcLandmarkModelBuilder(Cytomine cytomine) throws Exception {
    try {
        Software software = cytomine.addSoftware('LC_Landmark_Model_Builder', 'createRabbitJobWithArgsService',
                'ValidateAnnotation',
...
void addSoftwareLandmarkGenericPredictor(Cytomine cytomine) throws Exception {
    try {
        Software software = cytomine.addSoftware('Landmark_Generic_Predictor', 'createRabbitJobWithArgsService', 
                'ValidateAnnotation',
        ...
        cytomine.addSoftwareParameter('models_id_job', 'ListDomain', software.getId(), '', true, 1100,
                '/api/job.json?project=$currentProject$', 'softwareName', 'softwareName')
        cytomine.addSoftwareParameter('cytomine_predict_images', 'ListDomain', software.getId(), '', true, 1200, 
                '/api/project/$currentProject$/imageinstance.json', 'filename', 'filename')
    } catch (CytomineException e) {
        log.error(e)
    }
...
void addSoftwareLandmarkDmblPredictor(Cytomine cytomine) throws Exception {
    try {
        Software software = cytomine.addSoftware('Landmark_DMBL_Predictor', 'createRabbitJobWithArgsService', 
                'ValidateAnnotation',
...
void addSoftwareLandmarkLcPredictor(Cytomine cytomine) throws Exception {
    try {
